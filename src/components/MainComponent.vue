    ...
    <main>
        <div class="container h-100 d-flex justify-content-center align-items-center">
            ...
            <div class="row d-flex">
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-2 col-xxl-2 p-1 debug d-flex justify-content-center align-items-center" v-for="comic in lists" :key="comic.id" :id="comic.id">
